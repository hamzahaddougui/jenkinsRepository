...
// multi-threaded step:
    ...
    // throttle limit : 5
    // => use only 5 of 20 for evey step
    ...
    public Job balanceFileJob(JobCompletionNotificationListener jobCompletionNotificationListener)
    {
        ...
        return jobBuilderFactory.get("balance-file-in-loader-job")
    ...
    public PatternMatchingCompositeLineMapper lineMapper() throws IOException {
        ...
        detailTokenizer.setNames("recordType", "recordSequence", "bankCode", "accountNumber","currencyCode",
                           "balance","accountBalanceSign","facilities","blockedAmount","cutoffBalanceDate","cutoffBalanceId");
        ...
        // trailer tokenizer
        /*FixedLengthTokenizer trailerTokenizer = new FixedLengthTokenizer();
        trailerTokenizer.setNames("recordType","recordSequence","recordsCount");
        trailerTokenizer.setColumns(new Range(1,2),
                new Range(3,21),
                new Range(22,40)
        );*/

        Map<String, LineTokenizer> tokenizers = new HashMap<>();
        tokenizers.put("DT*", detailTokenizer);
        //tokenizers.put("TR*", trailerTokenizer);
        ...
        // trailer fieldset mapper
        /*BeanWrapperFieldSetMapper<TrailerRecord> TrailerfieldSetMapper = new BeanWrapperFieldSetMapper<TrailerRecord>();
        TrailerfieldSetMapper.setTargetType(TrailerRecord.class);*/
        ...
        mappers.put("DT*", FileInfieldSetMapper);
          //mappers.put("TR*", TrailerfieldSetMapper);
